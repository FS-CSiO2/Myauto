...
dir /B /a-d ".\">"当前文件夹列表1.txt"
dir /b /ad ".\" > "当前文件夹列表2.txt"
type "当前文件夹列表1.txt" > "当前文件夹列表.txt"
type "当前文件夹列表2.txt" >> "当前文件夹列表.txt"
del "当前文件夹列表1.txt"
del "当前文件夹列表2.txt"
cls
title 文件夹列表对比
...
echo 对比结果>对比结果.txt
:: 读取 当前文件夹列表.txt 的每一行，在 旧文件夹列表.txt 中搜索（需要先准备好旧文件夹列表.txt）
echo ================新增==================
echo ================新增==================>>对比结果.txt
...
set "PD="
:: 读取 旧文件夹列表.txt 的每一行，在 当前文件夹列表.txt 中搜索（需要先准备好旧文件夹列表.txt）
